...
while repeat == True:
    ...
    if antwoord1 == 'FAM': 
        ...
        if antwoord2 == 'SCHUIL':
            ...
            if antwoord5 == 'BRA':
                os.system('cls')
                antwoord6=input("je hebt besloten om met de bus naar het vliegveld te gaan om een vliegtuig naar Brazilië na heel veel geld en heel lang in het vliegtuig te zitten ben je dan eindelijk in Brazilië maar je begrijpt helemaal niks van de letters daar en je geld is ook op dus je kan nergens slapen behalve op straat je familie heeft honger en je zoon is ziek. Je ziet een man met een hele grote portemonnee. Steel jij zijn geld (type STEEL) of slaap je op straat (type STRAAT)?")
                if antwoord6 == 'STEEL':
                    os.system('cls')
                    print("je hebt gekozen om de man zijn portemonnee te stelen je volgt de man naar zijn huis terwijl hij zijn huissleutels pakt valt zijn portemonnee op de grond. Hij stapt binnen in zijn huis en dan hoor je dit achter je Olá senhor o que você está fazendo? Je begrijpt niet wat hij zegt maar het klinkt niet goed. Hij schreeuwt tegen je allemaal woorden die je niet begrijpt je wordt meegenomen naar het braziliaanse politie bureau. En word daar vast gehouden Je weet niet waar je famillie is en je bent erg bang. Maar je hebt wel eten en water. Dus het kon slechter gaan. je zit vast. einde.")
                    time.sleep(5)
